...
export const CATALOGUE_TABS: AreaTab[] = [
  {
    ...
    icon: Compass,
    hint: "The approved reference universe: every instrument approved into one of the four catalogues, in one searchable, filterable table. Published facts only — unapproved AI findings never appear here, and reference data does not affect portfolio math until a holding is recorded.",
