...
describe("Slice 8d · FindingCard wiring", () => {
  ...
  it("the 'Additional extracted details' label appears alongside ANY of the MMF, Bank, or CBK blocks, never unconditionally", () => {
  ...
  it("non-MMF, non-Bank, non-CBK findings (market-asset) send undefined figures — draftFromFinding's existing raw-extractedFields default is completely unchanged for them", () => {
