...
describe("Stage 10a · B — ResearchDesk.tsx: multi-field edit dialog", () => {
  it("EditCatalogueFieldsDialog exists and calls the updatePendingFields mutation (Stage 10b-1 generalized this from MMF-only to MMF + Bank, Stage 10b-2 extended it further to CBK, Stage 10b-3 extended it again to market_asset)", () => {
  ...
  it("the Edit fields entry point on the pending card is gated to MMF, Bank, or CBK (Stage 10b-1 extended it from MMF-only, Stage 10b-2 added CBK, Stage 10b-3 added market_asset) — see server/bankFieldParity.test.ts and server/cbkLiveWorkflowParity.test.ts for the catalogue-specific proofs", () => {
