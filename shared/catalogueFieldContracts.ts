...
const BANK_FIELD_CONTRACT: CatalogueFieldContract = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: "Fees / charges",
      required: false,
      aliases: ["fees", "feesCharges", "charges"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-1b — no DB column, but bank_instruments already has an extendedFields JSON home (same tier as productName/earlyWithdrawalRule). Lives in extendedFields.BankInstrumentProfile.fees only.",
    },
    {
      catalogue: "bank",
      key: "accessSpeed",
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-1b — no DB column, but bank_instruments already has an extendedFields JSON home (same tier as productName/earlyWithdrawalRule). Lives in extendedFields.BankInstrumentProfile.accessSpeed only.",
    },
    {
      catalogue: "bank",
      key: "sourceLink",
...
const MARKET_ASSET_EQUITY_FIELD_CONTRACT: CatalogueFieldContract = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: false,
      aliases: ["recentDividend"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — no first-class column, but opportunities already has an extendedFields JSON home (same tier as offshore fund's fxRiskNote). Lives in extendedFields.MarketAssetProfile.recentDividend only.",
    },
    {
      catalogue: "market_asset",
      subtype: "equity",
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — captures the source's OWN stated change figure verbatim (e.g. '+2.00% today'), never computed from history — no price-history table exists or is needed for this. Lives in extendedFields.MarketAssetProfile.priceChange only.",
    },
    {
      catalogue: "market_asset",
      subtype: "equity",
      ...
      label: "Market sector",
      required: false,
      aliases: ["marketSector"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — no first-class column; lives in extendedFields.MarketAssetProfile.marketSector only.",
    },
    {
      catalogue: "market_asset",
      subtype: "equity",
      ...
      required: false,
      aliases: ["minBuyAmount"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — opportunities has no minInvestment-equivalent COLUMN (unlike mmf_funds/bank_instruments), but extendedFields can hold it. Lives in extendedFields.MarketAssetProfile.minBuyAmount only.",
    },
    {
      catalogue: "market_asset",
      subtype: "equity",
    ...
    },
    {
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — captures the source's own stated risk level/rating verbatim (never a computed/derived rating). Lives in extendedFields.MarketAssetProfile.riskLevel only.",
    },
    {
      catalogue: "market_asset",
      subtype: "equity",
...
const MARKET_ASSET_REIT_FIELD_CONTRACT: CatalogueFieldContract = {
  ...
  fields: [
    ...
    },
    {
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — no first-class column (only the row-level assetClass='reit' umbrella); lives in extendedFields.MarketAssetProfile.reitType only.",
    },
    {
      catalogue: "market_asset",
      subtype: "reit",
    ...
    },
    {
      ...
      required: false,
      aliases: ["recentDistribution"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — no first-class column; lives in extendedFields.MarketAssetProfile.recentDistribution only.",
    },
    {
      catalogue: "market_asset",
      subtype: "reit",
    ...
    },
    {
      ...
      required: false,
      aliases: ["occupancyRate"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — added to MARKET_ASSET_EXTRACTION_SCHEMA; lives in extendedFields.MarketAssetProfile.occupancyRate only. Optional (\"if available\") per the product requirement.",
    },
    {
      catalogue: "market_asset",
      subtype: "reit",
      ...
      label: "Minimum investment",
      required: false,
      aliases: ["minInvestment"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — opportunities has no minInvestment-equivalent COLUMN, but extendedFields can hold it. Lives in extendedFields.MarketAssetProfile.minInvestment only.",
    },
    {
      catalogue: "market_asset",
      subtype: "reit",
    ...
    },
    {
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — captures the source's own stated risk level verbatim. Lives in extendedFields.MarketAssetProfile.riskLevel only.",
    },
    {
      catalogue: "market_asset",
      subtype: "reit",
...
const MARKET_ASSET_OFFSHORE_FUND_FIELD_CONTRACT: CatalogueFieldContract = {
  ...
  fields: [
    ...
    },
    {
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — no first-class column (only the row-level assetClass='offshore_fund' umbrella); lives in extendedFields.MarketAssetProfile.fundType only.",
    },
    {
      catalogue: "market_asset",
      subtype: "offshore_fund",
    ...
    },
    {
      ...
      label: "Withdrawal period",
      required: false,
      aliases: ["withdrawalPeriod"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — added to MARKET_ASSET_EXTRACTION_SCHEMA; lives in extendedFields.MarketAssetProfile.withdrawalPeriod only.",
    },
    {
      catalogue: "market_asset",
      subtype: "offshore_fund",
...
const MARKET_ASSET_SACCO_FIELD_CONTRACT: CatalogueFieldContract = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: false,
      aliases: ["membershipRequirement"],
      storageStatus: "extendedFields",
      managerEditable: true,
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — added to MARKET_ASSET_EXTRACTION_SCHEMA; lives in extendedFields.MarketAssetProfile.membershipRequirement only.",
    },
    {
      catalogue: "market_asset",
      subtype: "sacco",
    ...
    },
    {
      ...
      showInTable: false,
      promoteToCatalogueRow: false,
      note: "Stage 10b-3 — added to MARKET_ASSET_EXTRACTION_SCHEMA (distinct from offshore fund's 'fee'/expenseRatioPct); lives in extendedFields.MarketAssetProfile.fees only.",
    },
    {
      catalogue: "market_asset",
      subtype: "sacco",
